...
public final class LocomotiveControlApi {
    ...
    private Locomotive asLocomotive(String action) {
        ...
        if (action != null) {
            ScriptLog.apiWarn("control", action, "stock {} is not a locomotive", stock.getDefinitionID());
        }
        return null;
    }
    ...
    private LocomotiveDiesel asDiesel(String action) {
        ...
        if (action != null) {
            ScriptLog.apiWarn("control", action, "stock {} is not a diesel locomotive", stock.getDefinitionID());
        }
        return null;
    }
    ...
    private boolean requireServer(String action) {
        ...
        ScriptLog.apiIgnored("control", action, "server-side only");
        return false;
    }
