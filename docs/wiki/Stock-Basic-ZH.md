...
| 属性 | 章节 |
|------|------|
| `stock.control` | [机车控制](Control-ZH) |
| `stock.coupler` | [耦合器](Coupler-ZH) |
| `stock.readout` | [读数](Readout-ZH) |
| `stock.sound` | [音效](Sound-ZH) |
| `stock.animation` | [动画](Animation-ZH) |
| `stock.particle` | [烟雾与蒸汽](Particle-ZH) |
| `stock.cg_group` | [控制组](Cg-Group-ZH) |
