...
Repository: [github.com/wululapuda/IRScripts](https://github.com/wululapuda/IRScripts)

IR Scripts lets pack makers attach JavaScript to any IR stock definition — control locomotives, read gauges, play sounds, and expose in-game buttons — without writing a separate Forge mod.
...
完整 API 文档：[docs/Wiki-ZH.md](docs/Wiki-ZH.md)
